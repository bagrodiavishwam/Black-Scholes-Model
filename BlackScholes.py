...
if __name__ == '__main__':
    ...
    # strike price
    E = float(input('Strike price: '))
    # expiry 1year=365days
    T = float(input('Time of Expiry (in yrs): '))
    # risk-free rate
    rf = float(input('Risk-free rate of interest: '))
    # volatility of the underlying stock
    sigma = float(input('Volatility of underlying stock: '))
